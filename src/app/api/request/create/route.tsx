...
export async function POST(request: NextRequest) {
    ...
    try {
        const { name, email, collectionName } = await request.json();
        ...
        await User.findOneAndUpdate({ email: email, "collections.name": collectionName }, { $push: { "collections.$.requests": { name: name } } }, { new: true });
